...
# Método para ler uma palavra de forma aleatória do banco de palavra
def rand_palavra():
...
def main():
     ...
     # Cria o objeto e seleciona uma palavra aleatóriamente
     game = Hangman(rand_palavra())
     
     #Enquanto o jogo não estiver terminado, print do status, solicite uma letra e faz a leitura do caracter
